...
public class RetrofitTest {
    ...
    /** Maps API key */
    private String MAPS_API_KEY = null;

    /** Maps API restaurant type */
    private static final String MAPS_RESTAURANT_TYPE = "restaurant";

    /** Expected Restaurant */
    private static final int EXPECTED_RESTAURANT_COUNT = 5;

    /** Set up */
    @Before
    public void setUp() throws IOException {
        MAPS_API_KEY = BuildConfig.google_maps_api;
    }
    ...
    public void checkRestaurantNearBySynchronously() throws IOException {
        ...
        Call<ListRestaurant> restaurantsCall = restaurantRepository.getAllRestaurant(MAPS_ENDPOINT, "48.1159843,-1.7296427", 1000, MAPS_RESTAURANT_TYPE, MAPS_API_KEY);
